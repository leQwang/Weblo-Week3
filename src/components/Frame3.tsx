...
import vngLogo from "../img/vng-logo.png";
...
function Frame3() {
  ...
  return (
    <footer className="flex flex-col h-fit min-h-screen bg-[#ece8e1]">
      <div className="relative flex flex-col justify-end h-[250px] lg:h-[55vh] bg-footerBg bg-center bg-cover bg-no-repeat">
        <div className="relative flex items-center justify-center mb-20 lg:mb-32">
          <button
            onClick={() => redirectToLink("https://www.facebook.com/")}
            className="relative flex flex-col border-2 border-[#FF4655] bg-transparent p-7 overflow-hidden button__footer mx-5
          before:contents[''] before:w-1 before:h-1 before:bg-[#FF4655] before:border-white before:absolute before:-top-0 before:-right-0 before:z-10
          after:contents[''] after:w-1 after:h-1 after:bg-[#FF4655] after:border-white after:absolute after:-bottom-0 after:-left-0 after:z-10"
          >
            <div className="absolute bg-black w-[200%] h-[200%] -bottom-[200%] -left-[200%] skew-x-[45deg] duration-200"></div>
            <div className="absolute top-3 left-1 border-b border-[#FF4655] w-3 transform rotate-45 transform-origin-left"></div>
            <img src={facebook} alt="facebook icon" className="w-8 z-10" />
            <div className="absolute bottom-3 right-1 border-b border-[#FF4655] w-3 transform rotate-45 transform-origin-left"></div>
          </button>
          ...
          >
            ...
            <div className="absolute bg-black w-[200%] h-[200%] -bottom-[200%] -left-[200%] skew-x-[45deg] duration-200"></div>
            <div className="absolute top-3 left-1 border-b border-[#FF4655] w-3 transform rotate-45 transform-origin-left"></div>
            <img src={youtube} alt="facebook icon" className="w-8 z-10" />
            <div className="absolute bottom-3 right-1 border-b border-[#FF4655] w-3 transform rotate-45 transform-origin-left"></div>
          </button>
      ...
      <div className="relative flex flex-col justify-center items-center bg-[#ECE8E1]">
        ...
        <div className="flex flex-col  items-center font-bold mb-5">
          ...
          <a className="my-2" href="#">ĐIỀU KHOẢN SỬ DỤNG (VNG)</a>
        </div>
